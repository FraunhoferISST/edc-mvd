...
public class HansPeterAttestationsExtension implements ServiceExtension {

    public static final String NAME = "Hans Peter Attestations Extension";
    ...
    public void initialize(ServiceExtensionContext context) {
        registry.registerFactory("hans-peter", new HansPeterAttestationSourceFactory());
        validatorRegistry.registerValidator("hans-peter", new HansPeterAttestatonSourceValidator());
    }
}
